...
# Version    : 0.1.0                                                                               #
# Python     : 3.12.3                                                                              #
# Filename   : /appinsight/application/config/setup/profile.py                                     #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
# Modified   : Wednesday July 3rd 2024 04:54:53 pm                                                 #
# ------------------------------------------------------------------------------------------------ #
# License    : MIT License                                                                         #
...
# ------------------------------------------------------------------------------------------------ #
@dataclass
class ProfileDBSetupConfig(AppConfig):
    """
    Configuration class for creating tables

    Attributes:
        name (str): The name of the table to be created, the "profile" table.
