...
# Version    : 0.1.0                                                                               #
# Python     : 3.10.14                                                                             #
# Filename   : /genailabslm/infra/config/app.py                                                    #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
from genailabslm.infra.config.base import ConfigReader
...
class AppConfigReader(ConfigReader):
    ...
    def _load_base_config(self) -> Dict[str, Any]:
        ...
        filepath = os.path.join(directory, "base", "app.yaml")
    ...
    def _load_env_config(self) -> Dict[str, Any]:
        ...
        """
        directory = os.getenv("CONFIG_DIRECTORY", "config")
        filepath = os.path.join(directory, self.current_environment, "app.yaml")
