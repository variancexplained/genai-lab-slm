...
# Version    : 0.1.0                                                                               #
# Python     : 3.10.14                                                                             #
# Filename   : /discover/core/repo/factory.py                                                      #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
# Modified   : Friday September 20th 2024 07:54:37 pm                                              #
# ------------------------------------------------------------------------------------------------ #
# License    : MIT License                                                                         #
...
from discover.core.repo.base import ReviewRepo
from discover.core.repo.mckinney import McKinneyRepo
from discover.core.repo.zaharia import ZahariaRepo
from discover.substance.base.repo import RepoFactory
...
class ReviewRepoFactory(RepoFactory):
    ...
    Methods:
    --------
    get_repo(config: DatasetConfig) -> ReviewRepo:
    ...
    def get_repo(self, config: DatasetConfig) -> ReviewRepo:
        """
        ...
        self._logger.info(
            f"Created {repo.__class__.__name__} for {config.estage.description}"
        )
        return repo
