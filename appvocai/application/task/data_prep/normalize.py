...
# Version    : 0.1.0                                                                               #
# Python     : 3.12.3                                                                              #
# Filename   : /appvocai/application/task/data_prep/normalize.py                                   #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
import pandas as pd
from appvocai.application.data_prep.io import ReadTask, WriteTask
from appvocai.application.pipeline import Pipeline, PipelineBuilder, StageConfig, Task
