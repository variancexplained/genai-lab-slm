...
# Version    : 0.1.0                                                                               #
# Python     : 3.10.14                                                                             #
# Filename   : /discover/application/ops/cachenow.py                                               #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
# Modified   : Wednesday September 18th 2024 07:02:01 pm                                           #
# ------------------------------------------------------------------------------------------------ #
# License    : MIT License                                                                         #
...
from discover.application.ops.utils import find_dataframe, find_task, hash_dataframe
...
def cachenow(func):
    ...
    def wrapper(self, *args, **kwargs):
        ...
        run_task = task.config.force or not cache.exists(key=dataset_id)
