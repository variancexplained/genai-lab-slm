...
# Version    : 0.1.0                                                                               #
# Python     : 3.10.14                                                                             #
# Filename   : /tests/test_domain/test_entities/test_config/test_task_config.py                    #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
@pytest.mark.config
@pytest.mark.task_config
class TestTaskConfig:  # pragma: no cover
    # ============================================================================================ #
    ...
    def test_invalid_config(self, caplog) -> None:
        ...
        with pytest.raises(InvalidConfigException):
            _ = TaskConfig(service_context=3, task=2, force=3)
