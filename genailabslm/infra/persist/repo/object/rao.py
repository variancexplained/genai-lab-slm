...
# Modified   : Saturday January 25th 2025 05:27:10 pm                                              #
# ------------------------------------------------------------------------------------------------ #
# License    : MIT License                                                                         #
...
from genailabslm.infra.exception.object import (
    ObjectDatabaseNotFoundError,
    ObjectIOException,
    ObjectNotFoundError,
)
from genailabslm.infra.persist.repo.base import DAL
...
class RAO(DAL):
    ...
    def __init__(self, registry_path: str):
        ...
        self._logger.debug(f"RAO created at {registry_path}")
    ...
    def location(self) -> str:
        """Returns the location of the registry."""
