...
# Version    : 0.1.0                                                                               #
# Python     : 3.10.14                                                                             #
# Filename   : /discover/substance/entity/config/service.py                                        #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
# Modified   : Friday September 20th 2024 08:17:24 pm                                              #
# ------------------------------------------------------------------------------------------------ #
# License    : MIT License                                                                         #
...
# ------------------------------------------------------------------------------------------------ #
@dataclass
class DataPrepStageConfig(StageConfig):
    def __post_init__(self) -> None:
        self.target_data_config.force = self.force
