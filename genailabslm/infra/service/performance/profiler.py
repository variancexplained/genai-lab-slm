...
# Version    : 0.1.0                                                                               #
# Python     : 3.10.14                                                                             #
# Filename   : /genailabslm/infra/service/performance/profiler.py                                  #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
from genailabslm.application.ops.utils import find_task
from genailabslm.container import GenAILabSLMContainer
from genailabslm.dynamics.observability.profile import Profile
...
def profiler(func: Callable) -> Callable:
    ...
    def wrapper(self, *args, **kwargs):
        ...
        try:
            ...
            profile = Profile(
                phase=task.context.phase.label,
                stage=task.context.stage.label,
