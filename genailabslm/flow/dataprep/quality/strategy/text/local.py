...
# Version    : 0.1.0                                                                               #
# Python     : 3.10.14                                                                             #
# Filename   : /genailabslm/flow/dataprep/quality/strategy/text/local.py                           #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
from genailabslm.flow.dataprep.quality.strategy.text.pattern import Regex, RegexFactory
