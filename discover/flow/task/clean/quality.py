...
# Version    : 0.1.0                                                                               #
# Python     : 3.10.14                                                                             #
# Filename   : /discover/flow/task/clean/quality.py                                                #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
# ------------------------------------------------------------------------------------------------ #
class DetectOrRepairMinimumValueTask(DetectOrRemoveTask):
    """Task for detecting or repairing values below a specified minimum threshold.

    This class checks whether values in a given numeric column are below a specified
    minimum value. If in 'detect' mode, it creates a boolean indicator column to flag
    these values. The new column name is generated based on the original column name
