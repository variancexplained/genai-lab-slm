...
# Version    : 0.1.0                                                                               #
# Python     : 3.10.14                                                                             #
# Filename   : /discover/ops/task/clean/strategy/text/distributed.py                               #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
# Modified   : Thursday December 19th 2024 05:28:58 am                                             #
# ------------------------------------------------------------------------------------------------ #
# License    : MIT License                                                                         #
...
from discover.ops.task.clean.strategy.text import SPECIAL_ACCENT_MAP
from discover.ops.task.clean.strategy.text.pattern import RegexFactory
