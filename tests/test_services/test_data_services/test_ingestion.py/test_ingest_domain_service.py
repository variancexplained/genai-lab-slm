...
# Version    : 0.1.0                                                                               #
# Python     : 3.10.14                                                                             #
# Filename   : /tests/test_services/test_ingestion.py/test_ingest_service.py                       #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
# Modified   : Saturday September 14th 2024 03:36:37 am                                            #
# ------------------------------------------------------------------------------------------------ #
# License    : MIT License                                                                         #
...
class TestIngest:  # pragma: no cover
    ...
    def test_ingest(self, config, context, caplog) -> None:
        ...
        logger.info(double_line)
        # ---------------------------------------------------------------------------------------- #
        ingest = DataIngestionDomainService(config=config, context=context)
        data = ingest.run()
