...
# Version    : 0.1.0                                                                               #
# Python     : 3.12.3                                                                              #
# Filename   : /appinsight/shared/instrumentation/repo.py                                          #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
# Modified   : Thursday July 4th 2024 07:38:39 pm                                                  #
# ------------------------------------------------------------------------------------------------ #
# License    : MIT License                                                                         #
...
from appinsight.shared.instrumentation.profile import TaskProfile, TaskProfileDTO
from appinsight.shared.persist.database.base import DAL
